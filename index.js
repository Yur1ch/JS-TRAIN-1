...
// Створюємо змінну getAdder і присвоюємо результат виклику функції makeAdder з аргументом 5
...
// Створюємо змінну getDivider і присвоюємо результат виклику функції divide з аргументом 2
...
function memoizedArea() {
  let prevSide = null; // Зберігаємо попередню сторону
  let prevResult = null; // Зберігаємо попередній результат
...
// Створюємо змінну squareArea і присвоюємо результат виклику функції memoizedArea
...
// Створюємо змінну createCompose і присвоюємо результат виклику функції compose з аргументами increment та double
